...
```bash
git clone https://github.com/actionanand/ng-service-deep-dive.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/ng-service-deep-dive#1-skeleton angular-proj-name
```
